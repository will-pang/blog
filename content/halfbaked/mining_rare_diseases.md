...
With the recent launch of [ChatGPT Health](https://openai.com/index/introducing-chatgpt-health/) and [Claude for Healthcare](https://www.anthropic.com/news/healthcare-life-sciences) -- which promises the ability to "connect" your personal health data and chat with it -- it reminded me of a [paper](https://openreview.net/pdf?id=CrZyNUfWHp) I recently read titled "MIMIC-RD: Can LLMs differentially diagnose rare diseases in real-world clinical settings?" by health researchers at [UIUC](https://www.sunlab.org) (led by Jimeng Sun, John Wu and team) that seems ever more relevant.

To test the efficacy of LLMs in rare disease diagnoses, the researchers used the [MIMIC-IV clinical notes](https://physionet.org/content/mimiciv/3.1/) and specifically mined for "keywords" that might suggest a rare disease. Validated rare disease entities were then mapped to phenotypes from the [Human Pheontype Ontology](https://hpo.jax.org) (sort of like the doctor noting that you have swelling, which is a symptom shared by many diseases). **LLMs were then fed a list of a patient's observed symptoms, and asked to predict a list of 10 most likely diseases based on the symptoms.** The LLMs were scored as you would in a game of darts, that is, whether the rare disease falls within the top 1, 5, or 10 ranked predictions.
